...
const SwarmPlotHeight = React.memo(( {parameters, isDashboard} ) => {
  ...
  return (
    <ResponsiveSwarmPlotCanvas
      ...
      value="height"
      valueFormat=".2f"
      valueScale={isDashboard ? { type: 'linear', min: 150, max: 210, reverse: false } : { type: 'linear', min: 126, max: 226, reverse: false }}
      // size={{
      //   key: 'weight',
      //   values: [
      //     40,
